...
const NotFound= () => {
   return (
      <div className='notFound'>
         <div>
            <svg className='svg' width="1123" height="837" viewBox="0 0 1123 837" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         <div class="text">
            ...
            <h2>Не удалось запустить :(</h2>
               <h3>Страница не найдена, но можно выйти на <Link to="/"><span style={{'color': '#9f0013'}}>Главную страницу</span></Link></h3>
         </div>
</div>
